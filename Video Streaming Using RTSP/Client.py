...
class Client:
    ...
    def listenRtp(self):
        ...
        while True:
            try:
                print("listening")
                data = self.rtpSocket.recv(90480)
                if data:
                    rtpPacket = RtpPacket()
    ...
    def writeFrame(self, data):
        #edited by Prakhar Pandit CID 09
        ...
        if self.tag == 1:
            ...
            file = open("rcache.jpg", "wb")
            file.write(data.decode('base64'))
            file.close()
            cachename = "rcache.jpg"
            return cachename
    ...
    def connectToServer(self):
        ...
        try:
            ...
            print("connected......")
            msg = self.rtspSocket.recv(1024)
            print(str(msg))
            self.tag = input("Enter your Choise : ")
            print(self.tag)
            self.rtspSocket.sendall(bytes(self.tag, 'utf-8'))
